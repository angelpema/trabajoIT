...
<html lang="es">
    ...
    <body style="background: #f8f9fa;">
        ...
        <div class="container my-5">
            <h1 class="mb-4 text-center fw-bold">Categorías</h1>
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center flex-wrap gap-2">
                ...
                <s:form action="altaCategoria" style="margin:0;">
                            ...
                            <tr>
                                ...
                                <td class="text-nowrap">
                                    <div class="d-flex gap-2">
                                        <s:form action="modificarCategoria" method="post" style="margin:0;">
                                        ...
                                        <s:form action="eliminarCategoria" method="post" style="margin:0;">
                                            <s:hidden name="id" value="%{id}"/>
